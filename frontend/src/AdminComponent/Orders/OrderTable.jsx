...
const OrderTable = () => {
  ...
  useEffect(() => {
    dispatch(
      fetchRestaurantsOrder({ restaurantId: restaurant.userRestaurant.id, jwt })
    );
  }, []);
  ...
  return (
    <Box>
      <Card className="mt-1">
        <CardHeader title={"All Orders"} sx={{ pt: 1, alignItems: "center" }} />
              ...
              {restaurantOrder.orders.map((item) => (
                ...
                >
                  ...
                  <TableCell align="right">
                    {item.items.map((orderItem) => (
                      <div>
                        {orderItem.food.ingredients.map((ingredient) => (
