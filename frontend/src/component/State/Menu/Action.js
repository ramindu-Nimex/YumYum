  ...
  return async (dispatch) => {
    ...
    try {
      const {data} = await api.get(
        `/api/food/restaurant/${reqData.restaurantId}?vegetarian=${reqData.vegetarian}&nonVegetarian=${reqData.nonVegetarian}&seasonal=${reqData.seasonal}&food_category=${reqData.food_category}`,
        {
          headers: {
...
export const searchMenuItem = ({jwt, keyword}) => {
  return async (dispatch) => {
